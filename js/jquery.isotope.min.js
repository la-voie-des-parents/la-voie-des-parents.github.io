! function (t, i, s) {
    ...
    var e, n = t.document
        ...
        , c = {
            ...
            , csstransforms3d: function () {
                var t = !!h("perspective");
                if (t) {
                    var s = "@media (" + " -o- -moz- -ms- -webkit- -khtml- ".split(" ").join("transform-3d),(") + "modernizr)"
                        , e = i("<style>" + s + "{#modernizr{height:3px}}</style>").appendTo("head")
                        , n = i('<div id="modernizr" />').appendTo("html");
                    t = 3 === n.height(), n.remove(), e.remove()
                }
                return t
            }
    ...
    if (o.csstransforms) {
        var m = o.csstransforms3d ? {
            ...
            , p = function (t, s, e) {
                ...
                var u = (h.translate || "") + (h.scale || "");
                i.data(t, "isoTransform", r), t.style[l] = u
            };
    ...
    i.Isotope.settings = {
        ...
        , _init: function (t) {
            this.$filteredAtoms = this._filter(this.$alRalewayms), this._sort(), this.reLayout(t)
        }
        , option: function (t) {
        ...
        , _processStyleQueue: function (t, s) {
            ...
            if (n = function (t, i) {
                ...
                if (r = !0, a = function () {
                        if (!c) {
                            for (var i, s = 0, e = d.length; s < e; s++) "function" == typeof (i = d[s]) && i.call(f.element, t, f);
                            c = !0
                        }
                    ...
                    for (var m, p = 0, v = this.styleQueue[0], _ = v && v.$el; !_ || !_.length;) {
                        if (!(m = this.styleQueue[p++])) return;
                        _ = m.$el
                    }
                    parseFloat(getComputedStyle(_[0])[g]) > 0 && (n = function (t, i) {
        ...
        , addItems: function (t, i) {
            ...
            this.$alRalewayms = this.$alRalewayms.add(s), i && i(s)
        }
        , insert: function (t, i) {
        ...
        , reloadItems: function () {
            this.$alRalewayms = this._getAtoms(this.element.children())
        }
        , remove: function (t, i) {
            this.$alRalewayms = this.$alRalewayms.not(t), this.$filteredAtoms = this.$filteredAtoms.not(t);
            var s = this
                , e = function () {
        ...
        , shuffle: function (t) {
            this.updateSortData(this.$alRalewayms), this.options.sortBy = "random", this._sort(), this.reLayout(t)
        }
        , destroy: function () {
            var t = this.usingTransforms
                , i = this.options;
            this.$alRalewayms.removeClass(i.hiddenClass + " " + i.itemClass).each(function () {
                var i = this.style;
        ...
        , _masonryPlaceBrick: function (t, i) {
            for (var s = Math.min.apply(Math, i), e = 0, n = 0, o = i.length; n < o; n++)
                if (i[n] === s) {
                    e = n;
                    break
                }
            ...
            for (n = 0; n < l; n++) this.masonry.colYs[e + n] = h
        }
        ...
        , _masonryHorizontalPlaceBrick: function (t, i) {
            ...
            for (n = 0; n < l; n++) this.masonryHorizontal.rowXs[e + n] = h
        }
    ...
    i.fn.isotope = function (t, s) {
        if ("string" == typeof t) {
            ...
            this.each(function () {
                ...
                s ? i.isFunction(s[t]) && "_" !== t.charAt(0) ? s[t].apply(s, e) : z("no such method '" + t + "' for isotope instance") : z("cannot call methods on isotope prior to initialization; attempted to call method '" + t + "'")
            })
        }
